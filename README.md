...
**Real-time road accident analysis dashboard** powered by automated web scraping from **New Age Bangladesh**.
...
| **LLM/Extraction** | OpenAI structured extraction with Pydantic validation |
...
The first scrape may take 1–2 minutes as it fetches and processes articles from New Age.
