...
import {
  FaMapMarkerAlt, FaGlobeAsia, FaCarCrash,
  ...
  return (
    <div className="insights-page">
      <h2 className="page-title">
        <FaMapMarkerAlt className="text-cyan" /> District Deep Dive
      </h2>
      <p className="page-subtitle">
        Explore accident patterns for any district — monthly trends, vehicle breakdown,
        day-of-week patterns — and compare all divisions side by side.
      </p>
      ...
      {summary?.divisions?.length > 0 && (
        <div className="zones-divisions">
          ...
          {summary.divisions.map(div => {
            ...
            const divDistricts = zones
              .filter(z => z.division === div.division)
